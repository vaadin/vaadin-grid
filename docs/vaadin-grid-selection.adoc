...
[vaadinelement]#vaadin-grid# implements multi selection behavior by default.
...
[propertyname]#selectedItems#::
  It's the property that represents the Array of currently selected items. You can either use `selectItem` or `deselectItem` to modify the list, or modify the array directly by using Polymer API.
