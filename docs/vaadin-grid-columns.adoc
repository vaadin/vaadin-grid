...
Column reordering works automatically only when the data source is based on objects bound to the column configuration using the `name` attribute.
...
[source,javascript]
----
// Listening to changes in the column order
