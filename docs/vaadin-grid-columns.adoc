...
== Column Reordering
Non-frozen columns can be reordered by the end users by dragging the header cells.
By default, column reordering is disabled, and can be enabled by setting the [propertyname]#columnReorderingAllowed# property to true.
