...
[NOTE]
When using the column reordering feature, you must use objects as values and bind them to the column configuration using the `name` attribute.
See <<vaadin-grid-assigning-data#vaadin-grid.data.object, "Using Object Values">> for more details.
