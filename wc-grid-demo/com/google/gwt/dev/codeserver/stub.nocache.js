...
(function($wnd, $doc){
  ...
  if (devModeScript.addEventListener) {
    var callback = function() {
      console.log($wnd.confirmed + " " + serverUrl);
      if (!$wnd.confirmed && (!$wnd.__gwt_sdm__recompiler || !$wnd.__gwt_sdm__recompiler.loaded)) {
        $wnd.confirmed = true;
        if ($wnd.confirm(
            "Couldn't load " + confirmed + " " +  module + " from Super Dev Mode\n" +
            "server at " + serverUrl + ".\n" +
