...
if (WebComponents.flags.shadow) {
    ...
    (function(scope) {
        ...
        function assert(b, s) {
            if (!b) throw new Error("Assertion failed " + s);
        }
        var defineProperty = Object.defineProperty;
        ...
        function registerInternal(nativePrototype, wrapperConstructor, opt_instance) {
            ...
            assert(constructorTable.get(nativePrototype) === undefined, "A");
        ...
        function rewrap(node, wrapper) {
            ...
            assert(isNative(node), "D");
            assert(wrapper === undefined || isWrapper(wrapper), "E");
    ...
    (function(scope) {
        ...
        function removeAllChildNodes(wrapper) {
            if (wrapper.invalidateShadowRenderer()) {
                ...
                while (childWrapper) {
                    assert(childWrapper.parentNode === wrapper, "2");
        ...
        function Node(original) {
            assert(original instanceof OriginalNode, "3");
        ...
        mixin(Node.prototype, {
            ...
            insertBefore: function(childWrapper, refWrapper) {
                ...
                refWrapper && assert(refWrapper.parentNode === this, "4");
                var nodes;
    ...
    (function(scope) {
        ...
        function updateAllChildNodes(parentNodeWrapper) {
            assert(parentNodeWrapper instanceof Node, "6");
...
console.warn('platform.js is deprecated. Please upgrade to webcomponents.js (https://github.com/Polymer/webcomponentsjs).')