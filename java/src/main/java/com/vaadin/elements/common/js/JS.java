...
public abstract class JS {
    ...
    // Everything exported with this namespace can be instanciated from JS
    public static final String NAMESPACE_GRID = NAMESPACE_VAADIN + ".grid";
    // Everything exported with this namespace is unavailable after the app initialization
     ...
     */
    public static native void reasignProperties(Object o)
    /*-{
        if (o.__reasignPending) {
            delete o.__reasignPending;
            var p = o.__proto__;
